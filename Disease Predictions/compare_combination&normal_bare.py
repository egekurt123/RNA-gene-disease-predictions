...
plot_disease_embeddings_auprc_paper(embedding_datasets, disease_datasets, save_dir="plots/AuPRC", original=False, title_suffix="_combinations_compare_no_reduction")
